...
namespace Common
{
    ...
    public class PersistenceStorageObjectMappings : IPersistenceStorageObjectMappings
    {
        ...
        public PersistenceStorageObjectMappings()
        {
            ...
            _mappings.Add(typeof(Bookstore.EmployeeDepartments), new Bookstore_EmployeeDepartments_Mapper());
            ...
            _mappings.Add(typeof(Bookstore.Review), new Bookstore_Review_Mapper());
            ...
            _mappings.Add(typeof(ConceptsDemo.BorrowMoney), new ConceptsDemo_BorrowMoney_Mapper());
            _mappings.Add(typeof(ConceptsDemo.LendMoney), new ConceptsDemo_LendMoney_Mapper());
            _mappings.Add(typeof(ConceptsDemo.TestEntity), new ConceptsDemo_TestEntity_Mapper());
    ...
    public class Bookstore_Book_Mapper : IPersistenceStorageObjectMapper
    {
        public PersistenceStorageObjectParameter[] GetParameters(IEntity genericEntity)
        {
            ...
            return new PersistenceStorageObjectParameter[]
            {
                ...
                new PersistenceStorageObjectParameter("CreatedAt", new SqlParameter("", System.Data.SqlDbType.DateTime2) { Value = ((object)entity.CreatedAt) ?? DBNull.Value, Scale = 3 }),
    ...
    public class Bookstore_EducationRecord_Mapper : IPersistenceStorageObjectMapper
    {
        public PersistenceStorageObjectParameter[] GetParameters(IEntity genericEntity)
        {
            ...
            {
                new PersistenceStorageObjectParameter("ID", new SqlParameter("", System.Data.SqlDbType.UniqueIdentifier) { Value = entity.ID }),
                new PersistenceStorageObjectParameter("Date", new SqlParameter("", System.Data.SqlDbType.Date) { Value = ((object)entity.Date) ?? DBNull.Value }),
                new PersistenceStorageObjectParameter("Description", new SqlParameter("", System.Data.SqlDbType.NVarChar) { Value = ((object)entity.Description) ?? DBNull.Value }),
    ...
    public class Bookstore_Employee_Mapper : IPersistenceStorageObjectMapper
    {
        public PersistenceStorageObjectParameter[] GetParameters(IEntity genericEntity)
        {
            ...
            return new PersistenceStorageObjectParameter[]
            {
                ...
                new PersistenceStorageObjectParameter("VatNumber", new SqlParameter("", System.Data.SqlDbType.Int) { Value = ((object)entity.VatNumber) ?? DBNull.Value }),
    ...
    public class Bookstore_EmployeeDepartments_Mapper : IPersistenceStorageObjectMapper
    {
        public PersistenceStorageObjectParameter[] GetParameters(IEntity genericEntity)
        {
            var entity = (Bookstore.EmployeeDepartments)genericEntity;
            return new PersistenceStorageObjectParameter[]
            {
                new PersistenceStorageObjectParameter("ID", new SqlParameter("", System.Data.SqlDbType.UniqueIdentifier) { Value = entity.ID }),
                ...
                new PersistenceStorageObjectParameter("EmployeeID", new SqlParameter("", System.Data.SqlDbType.UniqueIdentifier) { Value = ((object)entity.EmployeeID) ?? DBNull.Value }),
                /*DataStructureInfo PersistenceStorageMapperPropertyMapping Bookstore.EmployeeDepartments*/
            };
        }
        ...
        {
            var entity = (Bookstore.EmployeeDepartments)genericEntity;
            /*DataStructureInfo PersistenceStorageMapperDependencyResolution Bookstore.EmployeeDepartments*/
            yield break;
        }
    
    	public string GetTableName()
        {
            return "Bookstore.EmployeeDepartments";
        }
    }
    ...
    public class Bookstore_Review_Mapper : IPersistenceStorageObjectMapper
    {
        public PersistenceStorageObjectParameter[] GetParameters(IEntity genericEntity)
        {
            var entity = (Bookstore.Review)genericEntity;
            return new PersistenceStorageObjectParameter[]
            {
                new PersistenceStorageObjectParameter("ID", new SqlParameter("", System.Data.SqlDbType.UniqueIdentifier) { Value = entity.ID }),
                new PersistenceStorageObjectParameter("BookID", new SqlParameter("", System.Data.SqlDbType.UniqueIdentifier) { Value = ((object)entity.BookID) ?? DBNull.Value }),
                new PersistenceStorageObjectParameter("LastModifiedTime", new SqlParameter("", System.Data.SqlDbType.Date) { Value = ((object)entity.LastModifiedTime) ?? DBNull.Value }),
                new PersistenceStorageObjectParameter("ReviewScore", new SqlParameter("", System.Data.SqlDbType.Decimal) { Value = ((object)entity.ReviewScore) ?? DBNull.Value, Precision = 28, Scale = 10 }),
                new PersistenceStorageObjectParameter("Text", new SqlParameter("", System.Data.SqlDbType.NVarChar) { Value = ((object)entity.Text) ?? DBNull.Value }),
                /*DataStructureInfo PersistenceStorageMapperPropertyMapping Bookstore.Review*/
            };
        }
        ...
        {
            var entity = (Bookstore.Review)genericEntity;
            /*DataStructureInfo PersistenceStorageMapperDependencyResolution Bookstore.Review*/
            yield break;
        }
    
    	public string GetTableName()
        {
            return "Bookstore.Review";
        }
    }
    ...
    public class ConceptsDemo_BorrowMoney_Mapper : IPersistenceStorageObjectMapper
    {
        public PersistenceStorageObjectParameter[] GetParameters(IEntity genericEntity)
        {
            var entity = (ConceptsDemo.BorrowMoney)genericEntity;
            return new PersistenceStorageObjectParameter[]
            {
                new PersistenceStorageObjectParameter("ID", new SqlParameter("", System.Data.SqlDbType.UniqueIdentifier) { Value = entity.ID }),
                ...
                /*DataStructureInfo PersistenceStorageMapperPropertyMapping ConceptsDemo.BorrowMoney*/
            };
        }
        ...
        {
            var entity = (ConceptsDemo.BorrowMoney)genericEntity;
            /*DataStructureInfo PersistenceStorageMapperDependencyResolution ConceptsDemo.BorrowMoney*/
            yield break;
        }
    
    	public string GetTableName()
        {
            return "ConceptsDemo.BorrowMoney";
        }
    }

    public class ConceptsDemo_LendMoney_Mapper : IPersistenceStorageObjectMapper
    {
        public PersistenceStorageObjectParameter[] GetParameters(IEntity genericEntity)
        {
            var entity = (ConceptsDemo.LendMoney)genericEntity;
            return new PersistenceStorageObjectParameter[]
            {
                new PersistenceStorageObjectParameter("ID", new SqlParameter("", System.Data.SqlDbType.UniqueIdentifier) { Value = entity.ID }),
                new PersistenceStorageObjectParameter("EventDate", new SqlParameter("", System.Data.SqlDbType.DateTime2) { Value = ((object)entity.EventDate) ?? DBNull.Value, Scale = 3 }),
                new PersistenceStorageObjectParameter("FromWhom", new SqlParameter("", System.Data.SqlDbType.NVarChar) { Value = ((object)entity.FromWhom) ?? DBNull.Value }),
                new PersistenceStorageObjectParameter("Amount", new SqlParameter("", System.Data.SqlDbType.Money) { Value = ((object)entity.Amount) ?? DBNull.Value }),
                /*DataStructureInfo PersistenceStorageMapperPropertyMapping ConceptsDemo.LendMoney*/
            };
        }
        ...
        {
            var entity = (ConceptsDemo.LendMoney)genericEntity;
            /*DataStructureInfo PersistenceStorageMapperDependencyResolution ConceptsDemo.LendMoney*/
            yield break;
        }
    
    	public string GetTableName()
        {
            return "ConceptsDemo.LendMoney";
        }
    }

    public class ConceptsDemo_TestEntity_Mapper : IPersistenceStorageObjectMapper
    {
        public PersistenceStorageObjectParameter[] GetParameters(IEntity genericEntity)
        {
            var entity = (ConceptsDemo.TestEntity)genericEntity;
            return new PersistenceStorageObjectParameter[]
            {
                new PersistenceStorageObjectParameter("ID", new SqlParameter("", System.Data.SqlDbType.UniqueIdentifier) { Value = entity.ID }),
                new PersistenceStorageObjectParameter("Code", new SqlParameter("", System.Data.SqlDbType.NVarChar) { Value = ((object)entity.Code) ?? DBNull.Value }),
                new PersistenceStorageObjectParameter("Name", new SqlParameter("", System.Data.SqlDbType.NVarChar) { Value = ((object)entity.Name) ?? DBNull.Value }),
                /*DataStructureInfo PersistenceStorageMapperPropertyMapping ConceptsDemo.TestEntity*/
            };
        }
        ...
        {
            var entity = (ConceptsDemo.TestEntity)genericEntity;
            /*DataStructureInfo PersistenceStorageMapperDependencyResolution ConceptsDemo.TestEntity*/
            yield break;
        }
    
    	public string GetTableName()
        {
            return "ConceptsDemo.TestEntity";
        }
    }
